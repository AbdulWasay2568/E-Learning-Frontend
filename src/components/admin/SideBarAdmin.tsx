...
const SideBarAdmin = () => {
  ...
  return (
    <>
      ...
      <nav className="fixed top-0 left-0 right-0 h-16 bg-gray-900 text-white flex items-center px-4 z-40 lg:hidden">
        <button
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-screen bg-gray-900 text-white flex flex-col z-50 transform transition-transform duration-300
